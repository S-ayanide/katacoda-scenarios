...
We are going to apply Container Kill Chaos Experiment on a `nginx` container in this scenario. You can apply chaos to any other application but for this scenario we are going to consider `nginx` as the application that we're going to apply chaos on.
